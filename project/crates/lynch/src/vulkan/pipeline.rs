...
impl Pipeline {
    ...
    > {
        ...
        let vertex_shader_module = create_shader_module(vertex_spv_file, device);
        let fragment_shader_module = create_shader_module(fragment_spv_file, device);
    ...
    > {
        ...
        let compute_shader_module = create_shader_module(compute_spv_file, device);
